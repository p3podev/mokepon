...
function selectMokepon(petPlayer) {
    fetch(`http://localhost:8081/mokepon/${playerId}`, {
...
function sendAttacks() {
    fetch(`http://localhost:8081/mokepon/${playerId}/attacks`, {
        method: "post",
        headers: {
            "Content-Type": "application/json"
        },
...
function pullAttacks() {
    fetch(`http://localhost:8081/mokepon/${enemyId}/attacks`)
        .then(function (res) {
            if (res.ok) {
                res.json()
...
function sendLocation(x, y) {
    fetch(`http://localhost:8081/mokepon/${playerId}/location`, {
        method: "post",
        headers: {
            "Content-Type": "application/json"
        },
